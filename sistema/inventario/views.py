...
class Stock(LoginRequiredMixin, View):
    ...
    def get(self, request):
        ...
        return render(request, 'inventario/producto/stock.html',contexto)

class StockProducto(LoginRequiredMixin, View):
    login_url = '/inventario/login'
    redirect_field_name = None
    ...
    def post(self, request):
        ...
        if form.is_valid():
            ...
            #De lo contrario lanzara el mismo formulario
            return render(request, 'inventario/producto/agregarProductoStock.html', {'form': form})
    ...
    def get(self,request):
        ...
        contexto = complementarContexto(contexto,request.user)  
        return render(request, 'inventario/producto/agregarProductoStock.html', contexto)
...
class ListarPedidos(LoginRequiredMixin, View):
    ...
    def get(self, request):
        ...
        for pedido in pedidos:
            pedido.subtotal = str(round(pedido.sub_monto * Decimal(0.88), 2))
